...
describe('Tests',async function(){
    ...
    it('display different forms', async () => {
        await page.goto(host);
        ...
        const createFormDisplay = await page.$eval('#createForm',el => el.style.display='none')
        const editFormDisplay = await page.$eval('#editForm', el => el.style.display='block')
